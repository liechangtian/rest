...
<div>
    ...
    <p>
        data format:
        <input id="jsonRadio0" type="radio" name="updateRadio" value="application/json;charset=utf-8" checked="checked"/>json
...
<div>
    ...
    <p>
        data format:
        <input id="jsonRadio" type="radio" name="saveRadio" value="application/json;charset=utf-8" checked="checked"/>json
